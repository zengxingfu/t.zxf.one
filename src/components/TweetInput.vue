<template>
  <div class="input-wrapper field">
    ...
    <div class="control">
      ...
      <textarea v-model="payload.content" :rows="2" class="textarea" placeholder="e.g. Hello world"></textarea>
    </div>
    <div class="field is-grouped position-group">
    ...
    <div class="field is-grouped is-grouped-right">
      <div class="file has-name is-small">
        <label class="file-label">
          ...
          <span class="file-cta">
            <span class="file-label is-loading">🌄 上传照片</span>
          </span>
          <span class="file-name">{{uploadAreaDisplay}}</span>
        </label>
      </div>
      <p class="control">
        <a
          ...
          v-bind:class="{'is-loading': publishing}"
          @click="publish"
        >📌 发布</a>
      </p>
    </div>
